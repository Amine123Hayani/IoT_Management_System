          ...
          <div class="card-body">
            ...
            <form action="/user/add-calibration.php?d=<?php echo $d; ?>" method="POST">
              ...
              <div class="form-group row text-center">
                ...
                <div class="col-12 col-md-9">
                  <input type="text" name="message" maxlength="125" value="<?php echo isset($_SESSION['form']['message']) ? $_SESSION['form']['message'] : '' ?>" id="message" class="form-control">
                </div>
              </div>
              <div class="form-group row text-center">
    ...
    $(document).ready(function() {
      ...
      addBtn.click(function(e) {
        ...
        if (readingValue.length <= 0) {
          ...
          eerreurs.push("<?php echo VALID_READING_NUM; ?>");
        }

        if (messageValue <= 0) {
          erreurs.push("<?php echo VALID_MESSAGE_REQ; ?>");
        } else if (messageValue > 125) {
          erreurs.push("<?php echo VALID_MESSAGE_MAX; ?>");
        }
        ...
        if (erreurs.length > 0) {
          ...
          for (var i = 0; i < erreurs.length; i++) {
            allrEreursHTML += generateErrorItem(erreurs[i]);
          }

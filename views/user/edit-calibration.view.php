            ...
            <form action="/user/calibration.php?d=<?php echo $d; ?>&op=update" method="POST">
              <div class="form-group row text-center">
                ...
                <div class="col-12 col-md-9">
                  <input type="text" name="reading" maxlength="5" value="<?php echo $calibration['value']; ?>" id="reading" class="form-control">
                </div>
              </div>
              <div class="form-group row text-center">
                ...
                <div class="col-12 col-md-9">
                  <input type="text" name="message" maxlength="125" value="<?php echo $calibration['message']; ?>" id="message" class="form-control">
                </div>
              </div>
              <div class="form-group row text-center">
                ...
                <div class="col-12 col-md-9">
                  <select name="operator" id="operator" class="form-control" required>
                    <?php foreach ($operators as $operator) { ?>
                      <option <?php echo ($operator['id'] == $calibration['operator_id']) ? "selected" : "" ?> value="<?php echo $operator['id']; ?>">

                ...
                <tbody>
                  <?php foreach ($rulesTable as $k => $rule) { ?>
                    <tr class="text-center">
                      ...
                      <td>
                        <a href="/user/rule.php?d=<?php echo $rule['ruleID']; ?>&op=edit" class="btn btn-info btn-sm">
                          <i class="fa fa-edit"></i>
                          Edit
                        </a>
                        <a href="/user/rule.php?d=<?php echo $rule['ruleID']; ?>&op=delete" class="btn btn-danger btn-sm delete">

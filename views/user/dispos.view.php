      ...
      <div class="col-12">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Dispos</li>
          </ol>
        </nav>
      </div>
    </div>
          ...
          <div class="card-body pb-0">
            <?php if (count($disposTable) > 0) { ?>
              <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                  <?php foreach ($disposTable as $k => $device) { ?>
                    <tr class="text-center">
                      ...
                      <td class="align-middle">
                        <a href="/user/device.php?d=<?php echo $device["id"]; ?>&op=show" class="btn btn-info btn-sm">
                          <i class="fa fa-eye"></i>
                          Show
                        </a>
                        <a href="/user/device.php?d=<?php echo $device["id"]; ?>&op=delete" class="btn btn-danger btn-sm delete">

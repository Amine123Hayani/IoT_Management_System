          ...
          <div class="card-body">
            ...
            <form action="/user/add-rule.php" method="POST">
                ...
                <div class="col-12 col-md-9">
                  <select name="sensor" id="sensor" class="form-control" required>
                    <?php foreach ($sensors as $sensor) { ?>
                      <option <?php echo (isset($_SESSION['form']) && $sensor['id'] == $_SESSION['form']['sensor']) ? "selected" : "" ?> value="<?php echo $sensor['id']; ?>">
                ...
                <div class="col-12 col-md-9">
                  <select name="actuator" id="actuator" class="form-control" required>
                    <?php foreach ($actuators as $actuator) { ?>
                      <option <?php echo (isset($_SESSION['form']) && $actuator['id'] == $_SESSION['form']['actuator']) ? "selected" : "" ?> value="<?php echo $actuator['id']; ?>">
              ...
              <div class="form-group row text-center">
                ...
                <div class="col-12 col-md-9">
                  <input type="text" name="reading" maxlength="5" value="<?php echo isset($_SESSION['form']['reading']) ? $_SESSION['form']['reading'] : '' ?>" id="reading" class="form-control">
                </div>
              </div>
              <div class="form-group row text-center">
                ...
                <div class="col-12 col-md-9">
                  <select name="operator" id="operator" class="form-control" required>
                    <?php foreach ($operators as $operator) { ?>
                      <option <?php echo (isset($_SESSION['form']) && $operator['id'] == $_SESSION['form']['operator']) ? "selected" : "" ?> value="<?php echo $operator['id']; ?>">
              ...
              <div class="form-group row text-center">
                ...
                <div class="col-12 col-md-9">
                  <select name="state" id="state" class="form-control" required>
                    <option <?php echo (isset($_SESSION['form']) && $_SESSION['form']['state'] == 1) ? "selected" : "" ?> value="1">ON</option>
                    <option <?php echo (isset($_SESSION['form']) && $_SESSION['form']['state'] == 0) ? "selected" : "" ?> value="0">OFF</option>
                  </select>
                </div>
              </div>

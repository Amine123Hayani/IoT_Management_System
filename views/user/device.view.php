       ...
       <div class="col-12">
         <nav aria-label="breadcrumb">
           <ol class="breadcrumb">
             ...
             <li class="breadcrumb-item"><a href="/user/dispos.php">Dispos</a></li>
         ...
         <div class="card shadow">
           <div class="card-body">
             <div class="text-center">
               <a href="/user/device.php?d=<?php echo $d; ?>&op=toggle" class="btn <?php echo $userDevice['is_on'] == 1 ? "btn-warning" : "btn-success"; ?>">
                 Turn <?php echo $userDevice['is_on'] == 1 ? "OFF" : "ON"; ?>
               </a>
               <a href="/user/device.php?d=<?php echo $d; ?>&op=delete" class="btn btn-danger delete">
                 Delete
               </a>
             </div>
           </div>
       ...
       <div class="col-12 col-md-8">
         <div class="card shadow mt-2">
           <div class="card-body">
             <h3 class="card-title font-weight-bold">
               Live Readings
               <span class="badge badge-success badge-pill d-none" id="updateBadge" style="font-size:12px;">
                 UPDATED
               </span>
             </h3>
             <hr>
           ...
           <div class="card-body pb-0">
             <div>
               <div class="float-right">
                 <button id="loadReadingsBtn" class="btn btn-info btn-sm">
                   <i id="loadReadingsSpinner" class="fa fa-spin fa-spinner d-none"></i>
                   Load More
                 </button>
                 <a href="/user/reading.php?d=<?php echo $d; ?>&op=delete-all" class="btn btn-danger btn-sm delete-all">
                   Delete All
                 </a>
               </div>
               <h3 class="card-title font-weight-bold">
             ...
             <table id="readingsTable" class="table table-bordered table-striped table-hover <?php echo count($readingsTable) > 0 ? '' : 'd-none'; ?>">
               <thead>
               ...
               <tbody id="readingsTableBody">
                 <?php foreach ($readingsTable as $k => $reading) { ?>
                   <tr class="text-center">
                     ...
                     <td>
                       <a href="/user/reading.php?d=<?php echo $reading['did']; ?>&op=delete" class="btn btn-danger btn-sm delete">
       ...
       <div class="col-12">
         <div class="card shadow mt-2">
           <div class="card-body pb-0">
             <div>
               <div class="float-right">
                 <button id="loadAlarmsBtn" class="btn btn-info btn-sm">
                   <i id="loadAlarmsSpinner" class="fa fa-spin fa-spinner d-none"></i>
                   Load More
                 </button>
                 <a href="/user/alarm.php?d=<?php echo $d; ?>&op=delete-all" class="btn btn-danger btn-sm delete-all">
                   Delete All
                 </a>
               </div>
               <h3 class="card-title font-weight-bold">
             ...
             <table id="alarmsTable" class="table table-bordered table-striped table-hover <?php echo count($alarmsTable) > 0 ? '' : 'd-none'; ?>">
               <thead>
                 <tr class="text-center">
                   <th>#</th>
                   <th>Reading</th>
               ...
               <tbody id="alarmsTableBody">
                 <?php foreach ($alarmsTable as $k => $alarm) { ?>
                   <tr class="text-center">
                     ...
                     <td>
                       <a href="/user/alarm.php?d=<?php echo $alarm['aid']; ?>&op=delete" class="btn btn-danger btn-sm delete">
                         <i class="fa fa-trash"></i>
                         Delete
                       </a>
                     </td>
             ...
             <div class="alert alert-warning <?php echo count($alarmsTable) <= 0 ? '' : 'd-none'; ?>" id="alarmsAlert">
               <p class="text-center m-0">
                 <?php echo NO_ALARMS; ?>
               </p>
             </div>
       ...
       <div class="col-12">
         <div class="card shadow mt-2">
           <div class="card-body pb-0">
             <div>
               <div class="float-right">
                 <a href="/user/add-calibration.php?d=<?php echo $d; ?>" class="btn btn-info btn-sm">
                   Add New Calibration
                 </a>
               </div>
               <h3 class="card-title font-weight-bold">
                 ...
                 <tbody>
                   <?php foreach ($calibrationsTable as $k => $calibration) { ?>
                     <tr class="text-center">
                       ...
                       <td>
                         <a href="/user/calibration.php?d=<?php echo $calibration['cid']; ?>&op=edit" class="btn btn-info btn-sm">
                           <i class="fa fa-edit"></i>
                           Edit
                         </a>
                         <a href="/user/calibration.php?d=<?php echo $calibration['cid']; ?>&op=delete" class="btn btn-danger btn-sm delete">
                           <i class="fa fa-trash"></i>
                           Delete
                         </a>
                       </td>

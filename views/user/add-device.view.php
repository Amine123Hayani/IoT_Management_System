            ...
            <form action="/user/add-device.php" method="POST">
              <div class="form-group row text-center">
                ...
                <div class="col-12 col-md-6 offset-0 offset-md-3">
                  <input type="text" class="form-control text-center" id="deviceCard" maxlength="15" value="<?php echo isset($_SESSION['form']['deviceCard']) ? $_SESSION['form']['deviceCard'] : '' ?>" name="deviceCard">
                  <div class="alert alert-danger mt-2 mb-0 <?php echo (isset($_SESSION['erreurs']) && count($_SESSION['erreurs']) > 0) ? '' : 'd-none'; ?>" id="erreursContainer">
              ...
              <div class="text-center">
                <button type="submit" id="addOpenBtn" name="btnChoice" value="1" class="btn btn-success">
                  Add and Open Device
                </button>
                <br>
                <button id="addBtn" type="submit" name="btnChoice" value="2" class="btn">
                  Add Device
                </button>
              </div>
            </form>
    ...
    $(document).ready(function() {
      ...
      var validFunc = function(e) {
        ...
        if (deviceCardValue <= 0) {
          erreurs.push("<?php echo VALID_DEVICECARD_REQ; ?>");
        } else if (deviceCardValue < 8) {
          erreurs.push("<?php echo VALID_DEVICECARD_MIN; ?>");
        } else if (deviceCardValue > 15) {
          erreurs.push("<?php echo VALID_DEVICECARD_MAX; ?>");
        }

      ...
      <div class="col-12">
        <div class="text-center">
          <div class="center-middle">
            <form action="/user/profile.php" method="POST" id="avatarForm" enctype="multipart/form-data">
          ...
          <img src="/uploads/avatars/<?php echo $_SESSION['auth']['avatar'] ? $_SESSION['auth']['avatar'] : 'default.png'; ?>" width="200" height="200" id="avatarImage" class="rounded-circle shadow shadow-lg border border-dark" alt="">
                ...
                <form action="/user/profile.php" method="POST">
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-md-9">
                      ...
                      <input type="text" name="firstName" value="<?php echo $userInfo['first_name']; ?>" id="firstName" class="form-control d-none toggle-input">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-md-9">
                      ...
                      <input type="text" name="lastName" value="<?php echo $userInfo['last_name']; ?>" id="lastName" class="form-control d-none toggle-input">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-md-9">
                      ...
                      <input type="date" name="birthDate" value="<?php echo $userInfo['birthdate']; ?>" id="birthDate" class="form-control d-none toggle-input">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-md-9">
                      ...
                      <select name="gender" id="gender" class="form-control d-none toggle-input">
                        <?php foreach ($genders as $gender) { ?>
                          <option <?php echo ($gender['id'] == $userInfo['gender_id']) ? "selected" : "" ?> value="<?php echo $gender['id']; ?>">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12 col-md-9">
                      ...
                      <textarea name="bio" id="bio" class="form-control d-none toggle-input" cols="30" rows="2"><?php echo $userInfo['bio']; ?></textarea>
                    </div>
                  </div>
    ...
    $(document).ready(function() {
      ...
      updateBtn.click(function(e) {
        ...
        if (birthDateValue > 10) {
          erreurs.push("<?php echo VALID_BIRTHDATE_MAX; ?>");
        }

        if (bioValue > 1000) {
          erreurs.push("<?php echo VALID_BIO_MAX; ?>");
        }

      ...
      <ul class="navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="#">
            <img src="<?php echo $websiteLogo; ?>" width="100" height="100" class="rounded-circle" alt="<?php echo $websiteName; ?>">
          </a>
        </li>
      </ul>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="text-center mt-3">
            <a href="/auth/login.php" class="btn btn-primary px-3 white-color">
              Login
            </a>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-12 col-md-3">
          <div class="text-center">
            <img src="/assets/images/Desert.jpg" class="rounded-circle shadow img-fluid" alt="">
          </div>
            ...
            <div class="card-body">
              <div class="media align-items-center">
                <div class="media-body">
                  <h5 class="mt-0 mb-1 font-weight-bold">Amine Hayani Soujaa</h5>
                  etudiant a l'estiam
                </div>
                <img src="/assets/images/flower.jpg" width="100" height="100" class="ml-3 rounded-circle" alt="...">
              </div>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-6 mt-2 mt-md-0">
          <div class="card shadow">
            <div class="card-body">
              <div class="media align-items-center">
                <div class="media-body">
                  <h5 class="mt-0 mb-1 font-weight-bold">Oussama jaaouan</h5>
                  etudiant a esisa , php et null
                </div>
                <img src="/assets/images/flower.jpg" width="100" height="100" class="ml-3 rounded-circle" alt="...">
              </div>
            </div>
